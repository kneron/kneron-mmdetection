...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True, leaky_slope=0.1):  # ch_in, ch_out, kernel, stride, padding, groups
        ...
        self.act = nn.LeakyReLU(leaky_slope, inplace=True) if act else Identity() 
    def forward(self, x):
